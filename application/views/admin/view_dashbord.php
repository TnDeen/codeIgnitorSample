	...
	<div class="row clearfix">
		<div class="col-md-12 column">
				...
				<thead>
                                    <tr>
                                        <th><input id="selecctall" type="checkbox">&nbsp;Check All</th><th>S. NO.</th><th>Item name</th><th>Weight<small><sub>(grms)</sub></small></th><th>Quantity</th><th>Total weight<small><sub>(grms)</sub></small></th><th>Transaction type</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <tr>
                            <td>
                                <label>Weight</label>  
                                <input id="weight" name="weight" placeholder="placeholder" class="form-control input-sm" type="text" autocomplete="off">
