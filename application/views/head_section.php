                    ...
                    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
                        <div class="navbar-header">
                            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                                ...
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                            </button> <a class="navbar-brand" href="<?php echo base_url() ?>">Jewllery Shop</a>
                        </div>
                        <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li><a href="#"><strong><font style="color:#fff">Daily Transaction Report</font></strong></a></li>
                            </ul>
                         <ul class="nav navbar-nav pull-right">
                                <li class="active">
                                    <a href="<?php echo base_url().'admin' ?>"><i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp;Admin</a>
                                </li>
                         </ul>
                        </div>
                    </nav>
